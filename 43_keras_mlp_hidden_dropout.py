...
# Интересно понаблюдать за тем, как возрастает верность на обучающем и тестовом наборе при увеличении числа периодов.
# Как видно из приведенного графика, эти две кривые сходятся, когда число периодов приблизительно равно 250, так что последующее обучение ничего не даст.

# Замечено, что сети со случайным прореживанием внутренних слоев часто лучше обобщаются на новые примеры из тестового набора.
# Интуитивно это можно объяснить тем, что каждый нейрон становится «умнее», потому что знает, что нельзя полагаться на соседей.
# В процессе тестирования прореживание не производится, т. е. используются все тщательно настроенные нейроны.
